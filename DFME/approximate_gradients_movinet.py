...
def estimate_gradient_objective(args, victim_model, clone_model, x, epsilon=1e-7, m=5, verb=False, num_classes=400, device="cpu", device_tf='/device:GPU:0', pre_x=False):
