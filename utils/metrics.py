...
def train_step_log(logger,loss,accuracy):
    ...
    logger.log('train_accuracy', accuracy, on_step=True, on_epoch=True, logger=True, prog_bar=False)
...
def validation_step_log(logger,loss,accuracy):
    ...
    logger.log('validation_accuracy', accuracy, on_step=True, on_epoch=True, logger=True, prog_bar=False)
...
def test_step_log(logger,loss,accuracy):
    ...
    '''
    logger.log('test_loss', loss, on_step=True, on_epoch=True, logger=True, prog_bar=False)
    logger.log('test_accuracy', accuracy, on_step=True, on_epoch=True, logger=True, prog_bar=True)
